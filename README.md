...
stream variants. [COMPATIBILITY.md](COMPATIBILITY.md) records the
...
The [CLI reference](docs/CLI.md) has C++, Python, and Java commands and API
examples. [COMPATIBILITY.md](COMPATIBILITY.md) states
...
- [CLI and API reference](docs/CLI.md)
