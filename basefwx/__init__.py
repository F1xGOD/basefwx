...
def b512decode(string: str, code: str=""): return basefwx.b512decode(string, code)
def pb512decode(string: str, code: str=""): return basefwx.pb512decode(string, code)

def b512encodefile(file: str, code: str): return basefwx.b512file_encode(file, code)
def b512decodefile(file: str, code: str=""): return basefwx.b512file_decode(file, code)
def b512handlefile(file: str, code: str=""): return basefwx.b512file(file, code)
def fwxAES(file: str, code: str="", light: bool = True): return basefwx.AESfile(file, code, light)
