...
can produce corrupted output. The [compatibility reference](../COMPATIBILITY.md#streaming-b512-recovery)
...
runtime; see [SECURITY.md](../SECURITY.md#payload-authentication).
