...
def kFMe(path: str, output: str | None = None, *, bw_mode: bool = False): return basefwx.kFMe(path, output, bw_mode=bw_mode)
def kFMd(path: str, output: str | None = None, *, bw_mode: bool = False): return basefwx.kFMd(path, output, bw_mode=bw_mode)
def kFAe(path: str, output: str | None = None, *, bw_mode: bool = False): return basefwx.kFAe(path, output, bw_mode=bw_mode)
def kFAd(path: str, output: str | None = None): return basefwx.kFAd(path, output)
