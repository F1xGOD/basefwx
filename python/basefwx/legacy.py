...
class basefwx:
    ...
    FWXAES_MAGIC = b"FWX1"
    FWXAES_ALGO = 0x01
    FWXAES_ALGO_PLUGIN = 0x03
    FWXAES_KDF_PBKDF2 = 0x01
    FWXAES_KDF_WRAP = 0x02
    FWXAES_PLUGIN_ID_LEN = 16
    FWXAES_PLUGIN_CONFIG_LEN_BYTES = 2
    FWXAES_PLUGIN_TAG_FIXED_LEN = FWXAES_PLUGIN_ID_LEN + 1 + FWXAES_PLUGIN_CONFIG_LEN_BYTES
    FWXAES_PLUGIN_MAX_CONFIG_LEN = 64 * 1024
    FWXAES_SALT_LEN = 16
    FWXAES_IV_LEN = 12
