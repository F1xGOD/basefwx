...
description: "C++, Python, and Java commands, flags, streaming APIs, and retired-data commands."
permalink: "/docs/CLI/"
generated_from: "docs/CLI.md"
doc_source: "docs/src/en_US/pages/cli.doc"
lang: "en-US"
doc_locale: "en_US"
---
...
output. See [streaming B512 recovery]({{ '/docs/COMPATIBILITY/' | relative_url }}#streaming-b512-recovery).
