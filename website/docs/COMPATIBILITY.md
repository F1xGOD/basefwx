...
layout: "doc"
title: "Compatibility"
description: "Portable variants, runtime exceptions, KDF limits, plugins, and retired-data recovery."
permalink: "/docs/COMPATIBILITY/"
generated_from: "COMPATIBILITY.md"
doc_source: "docs/src/en_US/pages/compatibility.doc"
lang: "en-US"
doc_locale: "en_US"
---
...
The checkout version comes from [VERSION](https://github.com/F1xGOD/basefwx/blob/main/VERSION). This page describes format
and runtime contracts that must survive a version change. Release history
belongs in [CHANGELOG.md](https://github.com/F1xGOD/basefwx/blob/main/CHANGELOG.md).
...
[SECURITY.md]({{ '/docs/SECURITY_MODEL/' | relative_url }}). Those constants are part of stored compatibility
...
layers. See [SECURITY.md]({{ '/docs/SECURITY_MODEL/' | relative_url }}#optional-master-recovery) for the
...
closed. The plugin C ABI has its own compatibility policy in [ABI.md]({{ '/docs/ABI/' | relative_url }}).
