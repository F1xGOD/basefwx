...
layout: "doc"
title: "Contributing"
description: "Change scope, test expectations, licensing, security reports, and review process."
permalink: "/docs/CONTRIBUTING/"
generated_from: "CONTRIBUTING.md"
doc_source: "docs/src/en_US/pages/contributing.doc"
lang: "en-US"
doc_locale: "en_US"
---
...
- New plugins for `examples/plugins/` (the templates are MIT OR
  Apache-2.0; see [LICENSING.md](https://github.com/F1xGOD/basefwx/blob/main/LICENSING.md)).
...
- Wire-format changes. Open an issue, and read
  [`SECURITY.md`]({{ '/docs/SECURITY_MODEL/' | relative_url }}) compatibility policy first.
...
that a translation is current. See [the source guide](https://github.com/F1xGOD/basefwx/blob/main/docs/src/README.md).
