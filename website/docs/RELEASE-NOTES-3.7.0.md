---
layout: "doc"
title: "BaseFWX 3.7.0 release notes"
description: "The 3.7.0 plugin ABI, wire tag, compatibility boundary, and upgrade notes."
permalink: "/docs/RELEASE-NOTES-3.7.0/"
generated_from: "RELEASE-NOTES-3.7.0.md"
doc_source: "docs/src/en_US/pages/release_notes_3_7_0.doc"
lang: "en-US"
doc_locale: "en_US"
---
...
([plugin.h](https://github.com/F1xGOD/basefwx/blob/main/cpp/include/basefwx/plugin.h)), the C++ helper layer
([plugin.hpp](https://github.com/F1xGOD/basefwx/blob/main/cpp/include/basefwx/plugin.hpp)) with two macro
variants for Profile-A (`BASEFWX_PLUGIN_DEFINE`) and Profile-B
(`BASEFWX_PLUGIN_DEFINE_KEYED`), the static-embed Registry
([plugin_static.hpp](https://github.com/F1xGOD/basefwx/blob/main/cpp/include/basefwx/plugin_static.hpp)), and
...
[examples/plugins/THREAT_MODEL.md](https://github.com/F1xGOD/basefwx/blob/main/examples/plugins/THREAT_MODEL.md)
...
The full security-policy stance lives in [SECURITY.md]({{ '/docs/SECURITY_MODEL/' | relative_url }});
