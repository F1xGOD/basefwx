...
description: "Cryptographic boundaries, password work, recovery policy, plugins, and private reporting."
permalink: "/docs/SECURITY_MODEL/"
generated_from: "SECURITY.md"
doc_source: "docs/src/en_US/pages/security.doc"
lang: "en-US"
doc_locale: "en_US"
---
...
The current checkout version is stored in [VERSION](https://github.com/F1xGOD/basefwx/blob/main/VERSION). A development
...
[streaming recovery boundary]({{ '/docs/COMPATIBILITY/' | relative_url }}#streaming-b512-recovery).
